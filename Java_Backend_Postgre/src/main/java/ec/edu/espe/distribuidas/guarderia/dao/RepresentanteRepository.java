 ...
 * @author Windows Boo
 */
public interface RepresentanteRepository extends
        JpaRepository<Representante, Integer> {

    Representante findByTipoIdentificacionAndIdentificacion(
            String tipoIdentificacion, String identificacion);
    
    Representante findByIdentificacion(String identificacion);

    Boolean existsByTipoIdentificacionAndIdentificacion(
            String tipoIdentificacion, String identificacion);

    List<Representante> findByApellidoStartingWithOrderByApellido(
            String apellido);
